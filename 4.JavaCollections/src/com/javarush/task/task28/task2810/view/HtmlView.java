...
//    private final String filePath = "C:\\Idea\\JavaRushTasks\\4.JavaCollections\\src\\com\\javarush\\task\\task28\\task2810\\view\\vacancies.html";
...
//    }
        ...
        try {
            ...
            Element origin = elements.first();
            Element copy = origin.clone();
            ...
            for (Vacancy vacancy : vacancies
                ...
                Element newElement = origin.clone();
                ...
                origin.before(newElement.outerHtml());
            }
